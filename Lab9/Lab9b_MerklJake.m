...
% Description: Integrate a function with different methods. Compare times.
% Due date: 27/03/2020
%
% Author: Jake Merkl
% Input: NO INPUT
...
function Lab9b_MerklJake()

f = @(x) exp(-x.^2); %Function declaration
tic  %Time start
